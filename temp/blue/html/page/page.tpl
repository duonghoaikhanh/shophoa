...
<div id="item_detail">
	<!-- BEGIN: img -->
	<div class="img"><div class="limit" style="width:{data.pic_w}px;height:{data.pic_h}px;"><a href="{data.link}" title="{data.title}"><img src="{data.picture}" alt="{data.title}" title="{data.title}" /></a></div></div>
  <!-- END: img --> 
